    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-bg-secondary bg-dots format-neubrutalism font-sans text-black relative">
      ...
      <div className="w-full max-w-md z-10 relative mt-12">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg font-medium mt-6">Start drawing collaboratively</p>
        </div>
        ...
        >
          ...
          <div className="space-y-2">
            <label htmlFor="name" className="block text-sm font-bold uppercase tracking-widest text-text-muted">
              Name
            </label>
            <input
              id="name"
        ...
        <p className="text-center font-semibold text-lg mt-8">
          ...
          <Link href="/login" className="text-accent hover:text-black transition-colors underline underline-offset-4 decoration-2">
            Sign in
          </Link>
        </p>
      </div>
