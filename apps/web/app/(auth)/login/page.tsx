  ...
  return (
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", fontFamily: "'Space Grotesk', sans-serif", overflow: "hidden" }}>
      ...
      <nav style={{ background: "#e8e8e8", borderBottom: "2px solid #000", display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 24px", flexShrink: 0, zIndex: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px", fontWeight: 900, fontSize: "17px", letterSpacing: "2px", textTransform: "uppercase" }}>
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        <div style={{
          ...
          {/* Purple square */}
          <div style={{ position: "absolute", top: "56px", left: "56px", width: "56px", height: "56px", background: "#a855f7", border: "2.5px solid #000", boxShadow: "4px 4px 0 #000", transform: "rotate(-10deg)" }} />

          {/* VER badge */}
          <div style={{ position: "absolute", top: "40px", right: "60px", fontSize: "11px", fontWeight: 900, background: "#d4ff4f", border: "2px solid #000", color: "#000", padding: "5px 12px", boxShadow: "3px 3px 0 #000", letterSpacing: "1px", transform: "rotate(-3deg)", textTransform: "uppercase" }}>
            VER: 0.1-ALPHA
          </div>

          {/* identicon placeholder */}
          <div style={{ position: "absolute", top: "110px", left: "42%", transform: "translateX(-50%)", textAlign: "center" }}>
            <div style={{ width: "56px", height: "56px", margin: "0 auto 4px", background: "repeating-linear-gradient(45deg, rgba(0,0,0,0.3) 0px, rgba(0,0,0,0.3) 8px, transparent 8px, transparent 16px)", border: "1px solid rgba(255,255,255,0.3)" }} />
            <div style={{ fontSize: "10px", color: "rgba(255,255,255,0.5)", letterSpacing: "1px" }}>Identicus<br />Sine</div>
          </div>

          {/* Bottom-right hatch shape */}
          <div style={{ position: "absolute", bottom: "110px", right: "48px", width: "76px", height: "76px", background: "repeating-linear-gradient(45deg, rgba(0,0,0,0.35) 0px, rgba(0,0,0,0.35) 10px, transparent 10px, transparent 20px)", border: "2px solid rgba(255,255,255,0.25)", transform: "rotate(15deg)" }} />
          ...
          <h1 style={{ fontWeight: 900, fontSize: "clamp(44px, 5.5vw, 68px)", lineHeight: 1, color: "#fff", textTransform: "uppercase", fontStyle: "italic", marginBottom: "22px", textShadow: "3px 3px 0 rgba(0,0,0,0.5)", letterSpacing: "-1px", position: "relative", zIndex: 2 }}>
            DRAW WITHOUT<br />LIMITS
          </h1>
          <div style={{ background: "#000", color: "#fff", display: "inline-block", padding: "14px 18px", fontWeight: 700, fontSize: "15px", lineHeight: 1.5, maxWidth: "290px", position: "relative", zIndex: 2 }}>
            The only canvas that<br />respects your chaos.
          </div>
        </div>

        {/* RIGHT PANEL */}
        <div style={{ flex: 1, background: "#f0f0eb", display: "flex", alignItems: "center", justifyContent: "center", padding: "32px 40px" }}>
          <div style={{ width: "100%", maxWidth: "500px" }}>

            {/* Card */}
            <div style={{ background: "#fff", border: "2.5px solid #000", boxShadow: "8px 8px 0 #000", padding: "44px 40px 36px" }}>

              <h2 style={{ fontWeight: 900, fontSize: "44px", textTransform: "uppercase", letterSpacing: "-1.5px", lineHeight: 1, marginBottom: "6px" }}>
                RESUME<br />SESSION
              </h2>
              <div style={{ width: "44px", height: "3px", background: "#5b5bd6", marginBottom: "28px" }} />

              {error && (
                <div style={{ background: "#ffe4e4", border: "2px solid #f43f5e", padding: "10px 14px", marginBottom: "18px", fontWeight: 700, fontSize: "13px", color: "#f43f5e" }}>
                  {error}
                </div>
              )}
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: "20px" }}>
                  ...
                  <input
                    ...
                    style={{ width: "100%", border: "2px solid #000", padding: "13px 16px", fontSize: "15px", fontFamily: "monospace", background: "#fff", outline: "none", boxSizing: "border-box", transition: "box-shadow 0.15s" }}
                ...
                <div style={{ marginBottom: "28px" }}>
                  <label style={{ display: "block", fontSize: "10px", fontWeight: 800, letterSpacing: "2px", textTransform: "uppercase", marginBottom: "7px", color: "#666" }}>KEY</label>
                  <div style={{ position: "relative" }}>
                    <input
                      ...
                      required
                      placeholder="••••••••••"
                      style={{ width: "100%", border: "2px solid #000", padding: "13px 44px 13px 16px", fontSize: "15px", fontFamily: "monospace", background: "#fff", outline: "none", boxSizing: "border-box", transition: "box-shadow 0.15s" }}
                      onFocus={e => (e.currentTarget.style.boxShadow = "3px 3px 0 #5b5bd6")}
                      onBlur={e => (e.currentTarget.style.boxShadow = "none")}
                    />
                ...
                <button type="submit" disabled={loading}
                  style={{ width: "100%", background: "#ff3b8f", color: "#fff", border: "2.5px solid #000", padding: "16px", fontWeight: 900, fontSize: "16px", letterSpacing: "2.5px", textTransform: "uppercase", cursor: loading ? "not-allowed" : "pointer", boxShadow: "4px 4px 0 #000", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", fontFamily: "'Space Grotesk', sans-serif", opacity: loading ? 0.7 : 1, transition: "transform 0.1s, box-shadow 0.1s" }}
                  ...
                  {loading ? "CONNECTING..." : "ENTER THE VOID"}
                  {!loading && <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" /></svg>}
                </button>
              </form>

              {/* Divider */}
              <div style={{ display: "flex", alignItems: "center", gap: "12px", margin: "22px 0 18px", color: "#aaa", fontSize: "10px", fontWeight: 800, letterSpacing: "2px", textTransform: "uppercase" }}>
              ...
              <div style={{ textAlign: "center", fontSize: "13px" }}>
                <span style={{ color: "#777" }}>New to the chaos? </span>
                <Link href="/signup" style={{ color: "#5b5bd6", fontWeight: 700, textDecoration: "underline", textUnderlineOffset: "3px" }}>
